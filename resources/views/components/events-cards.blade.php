<div class="bg-white shadow-[0_8px_12px_-6px_rgba(0,0,0,0.2)] border p-2 w-96 rounded-lg font-[sans-serif] overflow-hidden m-2 mt-4">
    ...
    <div class="flex items-center">
        <a href="" class="flex items-center">
            {{-- <img src="{{ asset("/uploads/events/{$event->user->image}") }}" class="h-10 w-10 rounded-full mr-2" alt="User Avatar"> --}}
    ...
    <a type="button" href="{{ route('events.eventShow', ['event' => $event->id]) }}" class="px-6 py-2 w-full mt-4 text-center rounded-lg text-white text-sm tracking-wider font-semibold border-none outline-none bg-blue-600 hover:bg-blue-700 active:bg-blue-600">
        View
    </a>
</div>
