    ...
    <div class="mx-auto bg-gray-700 h-screen flex items-center justify-center px-8"
        ...
        <div class="flex flex-col w-full bg-white rounded shadow-lg sm:w-3/4 md:w-1/2 lg:w-3/5">
            <div class="w-full h-64 bg-top bg-cover rounded-t"
                style="background-image: url({{ asset('uploads/events/' . $reservation->event->image) }})"></div>
            <div class="flex flex-col w-full md:flex-row">
                ...
                <div class="p-4 font-normal text-gray-800 md:w-3/4">
                    <h1 class="mb-4 text-4xl font-bold leading-none tracking-tight text-gray-800">title :
                        {{ $reservation->event->title }}</h1>
                ...
                <div class="w-1/3 flex justify-end">
                    <img src="https://www.printempsdunumerique.fr/wp-content/uploads/2016/09/code-barre-2d.jpg"
                        alt="Event Logo" class="w-8">
                </div>
            </div>
        </div>
    </div>
