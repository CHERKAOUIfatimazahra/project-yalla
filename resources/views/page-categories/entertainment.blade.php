    ...
    <section class="content">
        ...
        <div class="main-video">
            <div class="image-background">
                <img src="{{ asset('images/we-can-dance-forever2.png') }}" alt="">
            </div>
            ...
            <div class="video-background">
                <video autoplay muted loop id="myVideo">
                    <source src="{{ asset('images/concert-loop.mp4') }} " type="video/mp4">
                </video>
            </div>
        </div>
            ...
            <div class="container">
                ...
                <table class="event">
                    ...
                    {{-- <tr>
                            ...
                            <td class="event-thumb">
                                <a href="single-event.html">
                                    <img width="70" height="100" src="{{ asset(' images/upcoming-event-1.png') }}" alt="table-1"> 
                                </a>
                            </td>
                    ...
                    {{-- <tr>
                            ...
                            <td class="event-thumb">
                                <a href="single-event.html">
                                    <img width="70" height="100" src="{{ asset('images/upcoming-event-2.png') }} " alt="table-2"> 
                                </a>
                            </td>
                        ...
                        <tr>
                            ...
                            <td class="event-thumb">
                                <a href="single-event.html">
                                    <img width="70" height="100" src="{{ asset('images/upcoming-event-3.png') }}  " alt="table-3"> 
                                </a>
                            </td>
                        ...
                        <tr>
                            ...
                            <td class="event-thumb">
                                <a href="single-event.html">
                                    <img width="70" height="100" src="{{ asset('images/upcoming-event-4.png') }} " alt="table-4"> 
                                </a>
                            </td>
                        ...
                        <tr>
                            ...
                            <td class="event-thumb">
                                <a href="single-event.html">
                                    <img width="70" height="100" src="{{ asset('images/upcoming-event-5.png') }} " alt="table-5"> 
                                </a>
                            </td>
                    ...
                    <ul class="event-list">
                        <li>
                            <span class="img-thumb">
                                <a href="single-event.html">
                                    <img width="70" height="100" src="{{ asset('images/upcoming-event-1.png') }} "
                                        alt="table-1-1">
                                </a>
                            </span>
                        ...
                        <li>
                            <span class="img-thumb">
                                <a href="single-event.html">
                                    <img width="70" height="100" src="{{ asset('images/upcoming-event-2.png') }} "
                                        alt="table-1-2">
                                </a>
                            </span>
                        ...
                        <li>
                            <span class="img-thumb">
                                <a href="single-event.html">
                                    <img width="70" height="100" src="{{ asset('images/upcoming-event-3.png') }} "
                                        alt="table-1-3">
                                </a>
                            </span>
                            <p><span>Date :</span> <a href="#">26/03/2021</a></p>
                        ...
                        <li>
                            <span class="img-thumb">
                                <a href="single-event.html">
                                    <img width="70" height="100" src="{{ asset('images/upcoming-event-4.png') }} "
                                        alt="table-1-4">
                                </a>
                            </span>
                        ...
                        <li>
                            <span class="img-thumb">
                                <a href="single-event.html">
                                    <img width="70" height="100" src=" {{ asset('images/upcoming-event-5.png') }}"
                                        alt="table-1-5">
                                </a>
                            </span>
                        ...
                        <div class="swiper-wrapper">
                                ...
                                <div class="swiper-post">
                                    <div class="post-thumb">
                                        <a href="single-post.html">
                                            <img src="{{ asset('images/latest-blog-news-1.png') }} " alt="latest-news-img-1">
                            ...
                            <div class="swiper-slide">
                                <div class="swiper-post">
                                    <div class="post-thumb">
                                        <a href="single-post.html">
                                            <img src="{{ asset('images/latest-blog-news-2.png') }} " alt="latest-news-img-2">
                                            <div class="dugem-overlay"></div>
                                        </a>
                                    </div>
                                    <div class="post-content-wrap">
                            ...
                            <div class="swiper-slide">
                                <div class="swiper-post">
                                    <div class="post-thumb">
                                        <a href="single-post.html">
                                            <img src="{{ asset('images/latest-blog-news-3.png') }} " alt="latest-news-img-3">
                                            <div class="dugem-overlay"></div>
                                        </a>
                                    </div>
                                    <div class="post-content-wrap">
                            ...
                            <div class="swiper-slide">
                                <div class="swiper-post">
                                    <div class="post-thumb">
                                        <a href="single-post.html">
                                            <img src="{{ asset('images/latest-blog-news-4.png') }} " alt="latest-news-img-4">
                                            <div class="dugem-overlay"></div>
                                        </a>
                                    </div>
                                    <div class="post-content-wrap">
                            ...
                            <div class="swiper-slide">
                                <div class="swiper-post">
                                    <div class="post-thumb">
                                        <a href="single-post.html">
                                            <img src="{{ asset('images/latest-blog-news-5.png') }} " alt="latest-news-img-5">
                                            <div class="dugem-overlay"></div>
                                        </a>
                                    </div>
                                    <div class="post-content-wrap">
                        ...
                        <div class="swiper-wrapper">
                                ...
                                <div class="testi-content">
                                    ...
                                    <div class="testimonial-detail-inner">
                                        <div class="testimonial-image">
                                            <img src="{{ asset('images/testimonial-profile-1.png') }} " alt="testi-1">
                                        </div>
                                        <div class="test-info">
                            ...
                            <div class="swiper-slide">
                                <div class="testi-content">
                                    ...
                                    <div class="testimonial-detail-inner">
                                        <div class="testimonial-image">
                                            <img src="{{ asset('images/testimonial-profile-2.png') }} " alt="testi-2">
                                        </div>
                                        <div class="test-info">
